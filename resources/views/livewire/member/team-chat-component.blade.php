<div class="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden" wire:poll.3s>
    <div class="grid grid-cols-4 gap-0 h-[calc(100vh-250px)]">
                ...
                <div class="p-5 border-t border-gray-200 bg-white">
                    ...
                    <form wire:submit.prevent="sendMessage" class="flex gap-3">
                        <input type="text" 
                               ...
                               class="flex-1 px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                               wire:keydown.enter.prevent="sendMessage">
                        <button type="submit" 
                                wire:loading.attr="disabled"
                                class="px-8 py-3 bg-blue-600 text-white rounded-2xl hover:bg-blue-700 transition-all font-semibold text-sm flex items-center gap-2 shadow-md hover:shadow-lg disabled:opacity-50">
