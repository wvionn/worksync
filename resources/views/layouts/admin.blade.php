                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex-1 max-w-xl">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Search projects or tasks..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 ml-6">
                        <!-- Notification Bell -->
                        <a href="{{ route('admin.notifications.index') }}" class="relative p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
