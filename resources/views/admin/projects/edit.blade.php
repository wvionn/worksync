    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.projects.update', $project) }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="date" name="due_date" id="due_date" value="{{ old('due_date', $project->due_date?->format('Y-m-d')) }}" required
                ...
                <p class="mt-1 text-sm text-gray-500">Tanggal deadline wajib diisi</p>
                @error('due_date')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
